"""
Experiment 1 (v6): Final 2-Qubit Expressivity Evaluation

Configuration:
- Combined circuit depth (multi-layer rotations + entanglement)
- Improved observables (correlation-aware measurement operators)
- Extended training to full convergence (EPOCHS = 1500)
- GPU-accelerated execution

Objective:
Evaluate the maximum achievable performance of a 2-qubit hybrid QNN 
under combined architectural improvements, and identify the true 
performance plateau.

Key Questions:
1. Do circuit depth and observables provide complementary gains?
2. Where does performance plateau under extended training?
3. What is the practical benefit of GPU acceleration at this scale?
"""
