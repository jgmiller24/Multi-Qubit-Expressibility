"""
Experiment 1 (v4c): 2-qubit, 4-class hybrid QNN with increased training duration.

Objective:
Evaluate whether extending training (400 → 600 epochs) enables deeper circuits
...
plt.axis("off")
plt.savefig("sample_inputs_exp1v4c.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.title("Experiment 1 (v4c) Confusion Matrix")
plt.tight_layout()
plt.savefig("experiment1v4c_confusion_matrix.png", dpi=200)
plt.close()
...
plt.tight_layout()
plt.savefig("experiment1v4c_metrics.png", dpi=200)
plt.close()
