...
plt.axis("off")
plt.savefig("sample_inputs_ExpOpt_v3.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig("experimentOptv3_confusion_matrix.png", dpi=200)
plt.close()
...
plt.tight_layout()
plt.savefig("experimentOpt_v3_metrics.png", dpi=200)
plt.close()
