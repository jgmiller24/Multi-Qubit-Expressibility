"""
Experiment 2 (v2):  3-Qubit Scaling Evaluation - Incresed circuit depth
...
plt.axis("off")
plt.savefig("sample_inputs_Exp2_v2.png", dpi=200, bbox_inches="tight")
plt.close()
...
class HybridQNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc5 = nn.Linear(32, 6)   # Six circuit parameters
...
plt.title("Experiment 2 (v2) Confusion Matrix")
plt.tight_layout()
plt.savefig("experiment2v2_confusion_matrix.png", dpi=200)
plt.close()
...
plt.tight_layout()
plt.savefig("experiment2_v2_metrics.png", dpi=200)
plt.close()
