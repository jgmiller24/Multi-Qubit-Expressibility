"""
Experiment 2 (v3b):  3-Qubit Scaling Evaluation - 
...
plt.axis("off")
plt.savefig("sample_inputs_Exp2_v3b.png", dpi=200, bbox_inches="tight")
plt.close()
...
plt.title("Experiment 2 (v3b) Confusion Matrix")
plt.tight_layout()
plt.savefig("experiment2v3b_confusion_matrix.png", dpi=200)
plt.close()
...
plt.tight_layout()
plt.savefig("experiment2_v3b_metrics.png", dpi=200)
plt.close()
