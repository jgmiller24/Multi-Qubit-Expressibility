"""
Experiment 2 (v3):  3-Qubit Scaling Evaluation - Incresed circuit depth (3 rotation layers + 2 ladder entanglement) + Increased training (1000)
...
- Expanded observable set (8 outputs)S
